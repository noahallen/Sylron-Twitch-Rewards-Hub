! function e(t, s, n) {
    ...
    1: [function (e, t, s) {
        ...
        function a(e) {
            for (var t = "", s = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", n = 0; n < e; n++) t += s.charAt(Math.floor(Math.random() * s.length));
            return t
        }
        var c = "",
            l = "",
            ...
            d = {
                ...
                DeleteMessage: function (e, t) {
                    return !!h && (t || (t = c), h.deletemessage(t, e).catch(d.onError), !0)
                },
                GetClient: function () {
                    return h
                },
                Init: function (e, t, s, u) {
                    if (("string" == typeof (s = s || [e]) || s instanceof String) && (s = [s]), !Array.isArray(s)) throw new Error("Channels is not an array");
                    d.isDebug = u, c = s[0];
                    var p = {
                        options: {
                            debug: u
                    ...
                    t && (p.identity = {
                        ...
                        try {
                            ...
                            if (i || "!" !== n[0]) "action" === k || "chat" === k ? d.onChat(o, n, E, i, T) : "whisper" === k && d.onWhisper(o, n, E, i, T);
                            else {
                                var x = n.split(/ (.*)/),
                                ...
                                T.sinceLastCommand = function (e, t) {
                                    ...
                                    var s = new Date,
                                        n = {};
                                    return r.global[e] ? n.any = s - r.global[e] : n.any = 0, r.global[e] = s, t ? (r.users[t] || (r.users[t] = {}), r.users[t][e] ? n.user = s - r.users[t][e] : n.user = 0, r.users[t][e] = s) : n.user = null, n
                                }(N, f), d.onCommand(o, N, D, E, T)
                            }
                        } catch (e) {
                            d.onError(e)
                        }
                        ...
                        console.log("Connected:" + e + ":" + t), d.onConnected(e, t, m), m = !1
                    })), h.on("reconnect", (function () {
                        console.log("Reconnecting"), f++, d.onReconnect(f)
                    })), h.connect().catch(d.onError), t && async function e(t, s) {
                        let n;
                        s = s.replace("oauth:", "");
                        ...
                        if (!r.client_id || !r.scopes.includes("channel:read:redemptions") || !r.scopes.includes("user:read:email")) return void console.error("Invalid Password or Permission Scopes (channel:read:redemptions, user:read:email)");
                        ...
                        c = "undefined" != typeof window ? new WebSocket("wss://pubsub-edge.twitch.tv") : new o("wss://pubsub-edge.twitch.tv"), c.onopen = function (e) {
                            ...
                            switch (message = JSON.parse(n.data), message.type) {
                                case "RESPONSE":
                                ...
                                case "MESSAGE":
                                    if (message.data.topic.startsWith("channel-points-channel")) {
                                        ...
                                        if ("reward-redeemed" === e.type) {
                                            ...
                                            d.onReward(t.user.display_name || t.user.login, t.reward.title, t.reward.cost, t.user_input || "", i)
                                        }
                                    }
                            }
                        }, c.onclose = function () {
                            clearInterval(n), setTimeout(() => {
                                e(t, s)
                            }, 3e3)
                        }
                    }(c, t)
        ...
        void 0 !== t && t.exports && (t.exports = d), "undefined" != typeof window && (window.ComfyJS = d, n = window.tmi)
    }, {
        "node-fetch": 2,
        "tmi.js": 4,
        ws: 3
    ...
    2: [function (e, t, s) {
        (function (e) {
            ...
            t.exports = s = e.fetch, s.default = e.fetch.bind(e), s.Headers = e.Headers, s.Request = e.Request, s.Response = e.Response
    ...
    4: [function (e, t, s) {
        (function (t) {
            ! function t(s, n, i) {
                ...
                for (var r = "function" == typeof e && e, a = 0; a < i.length; a++) o(i[a]);
                return o
            }({
                1: [function (e, t, s) {
                    "use strict";
                ...
                2: [function (e, t, s) {
                    ...
                    t.exports = function (e, t) {
                        ...
                        if (i.isURL(s) || (s = "https://api.twitch.tv/kraken" + ("/" === s[0] ? s : "/" + s)), i.isNode()) n(i.merge({
                            ...
                            for (var r in o.open(e.method, e.url, !0), e.headers) o.setRequestHeader(r, e.headers[r]);
                ...
                3: [function (e, s, n) {
                    (function (t) {
                        ...
                        for (var f in h.inherits(m, o), m.prototype.api = n, i) m.prototype[f] = i[f];
                        m.prototype.handleMessage = function (e) {
                            ...
                            if (!h.isNull(e)) {
                                ...
                                if (h.isNull(e.prefix)) switch (e.command) {
                                    ...
                                    case "NOTICE":
                                        ...
                                        switch (i) {
                                            case "subs_on":
                                                this.log.info("[" + s + "] This room is now in subscribers-only mode."), this.emits(["subscriber", "subscribers", "_promiseSubscribers"], [g, g, d]);
                                                break;
                                            case "subs_off":
                                                this.log.info("[" + s + "] This room is no longer in subscribers-only mode."), this.emits(["subscriber", "subscribers", "_promiseSubscribersoff"], [_, _, d]);
                                                break;
                                            case "emote_only_on":
                                                this.log.info("[" + s + "] This room is now in emote-only mode."), this.emits(["emoteonly", "_promiseEmoteonly"], [g, d]);
                                                break;
                                            case "emote_only_off":
                                                this.log.info("[" + s + "] This room is no longer in emote-only mode."), this.emits(["emoteonly", "_promiseEmoteonlyoff"], [_, d]);
                                                break;
                                            case "slow_on":
                                            case "slow_off":
                                                break;
                                            ...
                                            case "followers_off":
                                                break;
                                            case "r9k_on":
                                                this.log.info("[" + s + "] This room is now in r9k mode."), this.emits(["r9kmode", "r9kbeta", "_promiseR9kbeta"], [g, g, d]);
                                                break;
                                            case "r9k_off":
                                                this.log.info("[" + s + "] This room is no longer in r9k mode."), this.emits(["r9kmode", "r9kbeta", "_promiseR9kbetaoff"], [_, _, d]);
                                                break;
                                            case "room_mods":
                                            ...
                                            case "bad_ban_staff":
                                            case "usage_ban":
                                                this.log.info(w), this.emits(["notice", "_promiseBan"], y);
                                                break;
                                            case "ban_success":
                                                this.log.info(w), this.emits(["notice", "_promiseBan"], b);
                                                break;
                                            case "usage_clear":
                                                this.log.info(w), this.emits(["notice", "_promiseClear"], y);
                                                break;
                                            case "usage_mods":
                                                this.log.info(w), this.emits(["notice", "_promiseMods"], [p, [i, []]]);
                                                break;
                                            case "mod_success":
                                                this.log.info(w), this.emits(["notice", "_promiseMod"], b);
                                                break;
                                            case "usage_vips":
                                                this.log.info(w), this.emits(["notice", "_promiseVips"], [p, [i, []]]);
                                                break;
                                            case "usage_vip":
                                            case "bad_vip_grantee_banned":
                                            case "bad_vip_grantee_already_vip":
                                                this.log.info(w), this.emits(["notice", "_promiseVip"], [p, [i, []]]);
                                                break;
                                            case "vip_success":
                                                this.log.info(w), this.emits(["notice", "_promiseVip"], b);
                                                break;
                                            case "usage_mod":
                                            case "bad_mod_banned":
                                            case "bad_mod_mod":
                                                this.log.info(w), this.emits(["notice", "_promiseMod"], y);
                                                break;
                                            case "unmod_success":
                                                this.log.info(w), this.emits(["notice", "_promiseUnmod"], b);
                                                break;
                                            case "unvip_success":
                                                this.log.info(w), this.emits(["notice", "_promiseUnvip"], b);
                                                break;
                                            case "usage_unmod":
                                            case "bad_unmod_mod":
                                                this.log.info(w), this.emits(["notice", "_promiseUnmod"], y);
                                                break;
                                            case "usage_unvip":
                                            case "bad_unvip_grantee_not_vip":
                                                this.log.info(w), this.emits(["notice", "_promiseUnvip"], y);
                                                break;
                                            case "color_changed":
                                                this.log.info(w), this.emits(["notice", "_promiseColor"], b);
                                                break;
                                            case "usage_color":
                                            case "turbo_only_color":
                                                this.log.info(w), this.emits(["notice", "_promiseColor"], y);
                                                break;
                                            case "commercial_success":
                                                this.log.info(w), this.emits(["notice", "_promiseCommercial"], b);
                                                break;
                                            case "usage_commercial":
                                            case "bad_commercial_error":
                                                this.log.info(w), this.emits(["notice", "_promiseCommercial"], y);
                                                break;
                                            ...
                                            case "bad_host_error":
                                            case "usage_host":
                                                this.log.info(w), this.emits(["notice", "_promiseHost"], [p, [i, null]]);
                                                break;
                                            case "already_r9k_on":
                                            case "usage_r9k_on":
                                                this.log.info(w), this.emits(["notice", "_promiseR9kbeta"], y);
                                                break;
                                            case "already_r9k_off":
                                            case "usage_r9k_off":
                                                this.log.info(w), this.emits(["notice", "_promiseR9kbetaoff"], y);
                                                break;
                                            case "timeout_success":
                                                this.log.info(w), this.emits(["notice", "_promiseTimeout"], b);
                                                break;
                                            case "delete_message_success":
                                                this.log.info("[" + s + " " + n + "]"), this.emits(["notice", "_promiseDeletemessage"], b);
                                            case "already_subs_off":
                                            case "usage_subs_off":
                                                this.log.info(w), this.emits(["notice", "_promiseSubscribersoff"], y);
                                                break;
                                            case "already_subs_on":
                                            case "usage_subs_on":
                                                this.log.info(w), this.emits(["notice", "_promiseSubscribers"], y);
                                                break;
                                            case "already_emote_only_off":
                                            case "usage_emote_only_off":
                                                this.log.info(w), this.emits(["notice", "_promiseEmoteonlyoff"], y);
                                                break;
                                            case "already_emote_only_on":
                                            case "usage_emote_only_on":
                                                this.log.info(w), this.emits(["notice", "_promiseEmoteonly"], y);
                                                break;
                                            case "usage_slow_on":
                                                this.log.info(w), this.emits(["notice", "_promiseSlow"], y);
                                                break;
                                            case "usage_slow_off":
                                                this.log.info(w), this.emits(["notice", "_promiseSlowoff"], y);
                                                break;
                                            case "usage_timeout":
                                            ...
                                            case "bad_timeout_staff":
                                                this.log.info(w), this.emits(["notice", "_promiseTimeout"], y);
                                                break;
                                            case "untimeout_success":
                                            case "unban_success":
                                                this.log.info(w), this.emits(["notice", "_promiseUnban"], b);
                                                break;
                                            case "usage_unban":
                                            case "bad_unban_no_ban":
                                                this.log.info(w), this.emits(["notice", "_promiseUnban"], y);
                                                break;
                                            case "usage_delete":
                                            case "bad_delete_message_error":
                                            case "bad_delete_message_broadcaster":
                                            case "bad_delete_message_mod":
                                                this.log.info(w), this.emits(["notice", "_promiseDeletemessage"], y);
                                                break;
                                            case "usage_unhost":
                                            case "not_hosting":
                                                this.log.info(w), this.emits(["notice", "_promiseUnhost"], y);
                                                break;
                                            ...
                                            case "whisper_restricted_recipient":
                                                this.log.info(w), this.emits(["notice", "_promiseWhisper"], y);
                                                break;
                                            case "no_permission":
                                            case "msg_banned":
                                            ...
                                            case "unrecognized_cmd":
                                                this.log.info(w), this.emit("notice", s, i, n), "/w" === n.split(" ").splice(-1)[0] && this.log.warn("You must be connected to a group server to send or receive whispers.");
                                                break;
                                            case "cmds_available":
                                            ...
                                            case "usage_help":
                                            case "usage_me":
                                                this.log.info(w), this.emit("notice", s, i, n);
                                                break;
                                            case "host_on":
                                            case "host_off":
                                                break;
                                            default:
                                                n.includes("Login unsuccessful") || n.includes("Login authentication failed") || n.includes("Error logging in") || n.includes("Improperly formatted auth") ? (this.wasCloseCalled = !1, this.reconnect = !1, this.reason = n, this.log.error(this.reason), this.ws.close()) : n.includes("Invalid NICK") ? (this.wasCloseCalled = !1, this.reconnect = !1, this.reason = "Invalid NICK.", this.log.error(this.reason), this.ws.close()) : this.log.warn("Could not parse NOTICE from tmi.twitch.tv:\n" + JSON.stringify(e, null, 4))
                                        }
                                        break;
                                    case "USERNOTICE":
                                        var S = e.tags["display-name"] || e.tags.login,
                                            E = e.tags["msg-param-sub-plan"] || "",
                                            T = h.unescapeIRC(h.get(e.tags["msg-param-sub-plan-name"], "")) || null,
                                            x = E.includes("Prime"),
                                            N = e.tags,
                                        ...
                                        switch (N["message-type"] = i, i) {
                                            ...
                                            case "giftpaidupgrade":
                                                var M = e.tags["msg-param-sender-name"] || e.tags["msg-param-sender-login"];
                                    ...
                                    case "HOSTTARGET":
                                        var L = n.split(" ");
                                        R = ~~L[1] || 0;
                                        "-" === L[0] ? (this.log.info("[" + s + "] Exited host mode."), this.emits(["unhost", "_promiseUnhost"], [
                                            [s, R],
                                            [null]
                                        ])) : (this.log.info("[" + s + "] Now hosting " + L[0] + " for " + R + " viewer(s)."), this.emit("hosting", s, L[0], R));
                                        break;
                                    case "CLEARCHAT":
                                        if (e.params.length > 1) {
                                            var A = h.get(e.tags["ban-duration"], null);
                                            h.isNull(A) ? (this.log.info("[" + s + "] " + n + " has been banned."), this.emit("ban", s, n, null, e.tags)) : (this.log.info("[" + s + "] " + n + " has been timed out for " + A + " seconds."), this.emit("timeout", s, n, null, ~~A, e.tags))
                                    ...
                                    case "CLEARMSG":
                                        if (e.params.length > 1) {
                                            S = e.tags.login;
                                            var U = n;
                                            (N = e.tags)["message-type"] = "messagedeleted", this.log.info("[" + s + "] " + S + "'s message has been deleted."), this.emit("messagedeleted", s, S, U, N)
                                        }
                                        break;
                                    case "RECONNECT":
                                    ...
                                    case "GLOBALUSERSTATE":
                                        this.globaluserstate = e.tags, void 0 !== e.tags["emote-sets"] && this._updateEmoteset(e.tags["emote-sets"]);
                                        break;
                                    case "ROOMSTATE":
                                        if (h.channel(this.lastJoined) === h.channel(e.params[0]) && this.emit("_promiseJoin", null), e.tags.channel = h.channel(e.params[0]), this.emit("roomstate", h.channel(e.params[0]), e.tags), !e.tags.hasOwnProperty("subs-only")) {
                                            if (e.tags.hasOwnProperty("slow"))
                                                ...
                                                } else this.log.info("[" + s + "] This room is no longer in slow mode."), this.emits(["slow", "slowmode", "_promiseSlowoff"], [
                                                    [s, !1, 0],
                                                    [s, !1, 0],
                                                    [null]
                                                ]);
                                    ...
                                    case "JOIN":
                                        ...
                                        h.isJustinfan(this.getUsername()) && this.username === J && (this.lastJoined = s, this.channels.push(s), this.log.info("Joined " + s), this.emit("join", s, J, !0)), this.username !== J && this.emit("join", s, J, !1);
                                        break;
                                    case "PART":
                                        var G, B = !1;
                                        J = e.prefix.split("!")[0];
                                        if (this.username === J) B = !0, this.userstate[s] && delete this.userstate[s], -1 !== (G = this.channels.indexOf(s)) && this.channels.splice(G, 1), -1 !== (G = this.opts.channels.indexOf(s)) && this.opts.channels.splice(G, 1), this.log.info("Left " + s), this.emit("_promisePart", null);
                                        this.emit("part", s, J, B);
                                        break;
                                    case "WHISPER":
                                        J = e.prefix.split("!")[0];
                                        this.log.info("[WHISPER] <" + J + ">: " + n), e.tags.hasOwnProperty("username") || (e.tags.username = J), e.tags["message-type"] = "whisper";
                                    ...
                                    case "PRIVMSG":
                                        if (e.tags.username = e.prefix.split("!")[0], "jtv" === e.tags.username) {
                                            ...
                                            } else n.includes("hosting you") && this.emit("hosted", s, W, 0, z)
                                        } else {
                                            var F = h.actionMessage(n);
                                            F ? (e.tags["message-type"] = "action", this.log.info("[" + s + "] *<" + e.tags.username + ">: " + F[1]), this.emits(["action", "message"], [
                                                [s, e.tags, F[1], !1]
                            ...
                            return new Promise((function (o, r) {
                                ...
                                })), h.isNull(i.ws) || 2 === i.ws.readyState || 3 === i.ws.readyState) r("Not connected to server.");
                                else {
                                    if (h.isNull(t)) i.log.info("Executing command: " + s), i.ws.send(s);
                                    else {
                                        var a = h.channel(t);
                            ...
                            var s = h.channel(e);
                            return this.moderators[s] || (this.moderators[s] = []), this.moderators[s].includes(h.username(t))
                        ...
                        }, m.prototype.utils = l, void 0 !== s && s.exports && (s.exports = m), "undefined" != typeof window && (window.tmi = {}, window.tmi.client = m, window.tmi.Client = m)
                ...
                4: [function (e, t, s) {
                    ...
                    t.exports = {
                        ...
                        join: function (e) {
                            var t = this;
                            return e = u.channel(e), this._sendCommand(this._getPromiseDelay(), null, "JOIN " + e, (function (s, n) {
                ...
                5: [function (e, t, s) {
                    ...
                    String.prototype.startsWith || (String.prototype.startsWith = function (e, t) {
                        ...
                        if (i(s)) switch (arguments.length) {
                            ...
                            for (a = Array.prototype.slice.call(arguments, 1), n = (l = s.slice()).length, c = 0; n > c; c++) l[c].apply(this, a);
                        return !0
                    }, n.prototype.addListener = function (e, t) {
                        var s;
                        if (!i(t)) throw TypeError("listener must be a function");
                        return this._events || (this._events = {}), this._events.newListener && this.emit("newListener", e, i(t.listener) ? t.listener : t), this._events[e] ? o(this._events[e]) ? this._events[e].push(t) : this._events[e] = [this._events[e], t] : this._events[e] = t, o(this._events[e]) && !this._events[e].warned && ((s = r(this._maxListeners) ? n.defaultMaxListeners : this._maxListeners) && s > 0 && this._events[e].length > s && (this._events[e].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[e].length), "function" == typeof console.trace && console.trace())), this
                        ...
                        if (r = (s = this._events[e]).length, n = -1, s === t || i(s.listener) && s.listener === t) {
                ...
                6: [function (e, t, s) {
                    ...
                    t.exports = {
                        levenshtein: function (e, t, s) {
                            if ((s = n.get(s, !1)) || (e = e.toLowerCase(), t = t.toLowerCase()), e == t) return 0;
                            var i = e.length,
                                o = t.length;
                            if (0 === i) return 1 * o;
                            if (0 === o) return 1 * i;
                            ...
                            var a, c, l, u, h, m, f = new Array(o + 1),
                                d = new Array(o + 1);
                            for (c = 0; o >= c; c++) f[c] = 1 * c;
                            for (a = 0; i > a; a++) {
                                for (d[0] = f[0] + 1, c = 0; o > c; c++)(l = f[c] + (e[a] == t[c] ? 0 : 1)) > (u = f[c + 1] + 1) && (l = u), l > (h = d[c] + 1) && (l = h), d[c + 1] = l;
                                m = f, f = d, d = m
                            }
                            return f[o]
                        },
                        raffle: {
                            ...
                            leave: function (e, t) {
                                ...
                                return s >= 0 && (this.raffleChannels[n.channel(e)].splice(s, 1), !0)
                            },
                            pick: function (e) {
                                this.init(e);
